...
Allpay.prototype = {
  ...
  checkOutResultNotify: function(opts, callback){
    let recieve_check_mac_value = opts.CheckMacValue;
    if( recieve_check_mac_value === this.genCheckMacValue(opts) ){
      return 'OK'
    }else{
      return '0'
    }
